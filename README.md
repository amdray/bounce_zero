...
- Чтение и использование оригинальных игровых данных из JAR-версии Bounce 2002:
    ...
    - система сейвов (в dat файл, пока что не использует систему сохранений Sony PSP) - **исправлено в 1.1**
...
- шрифт состоит из пикселей, не из текстур, нагрузка на консоль чуть сильнее чем могло быть - **исправлено в 1.1**
